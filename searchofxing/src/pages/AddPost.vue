<template>
  <div id="app" style="margin: 0 auto">
    <a-layout class="layout" style="background-color: white">
      <a-layout-header
        style="
          margin-bottom: 4px;
      ...
      <a-layout-content>
        ...
        <div v-show="selectedKey[0] == '2'" style="height: 100vh">
          <mavon-editor
            v-model="text"
            :toolbars="tools"
            style="height: 100%"
